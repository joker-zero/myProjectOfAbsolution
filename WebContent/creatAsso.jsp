...
<head>
	...
	<link rel="stylesheet" href="<%=path%>/css/myAssociation.css" type="text/css">
	<!--必要样式-->
...
<body>
		...
		<div class="content">
			<div id="large-header" class="large-header" style="height: 975px;">
				...
				<div class="context_mid">
					<form id="context_mid_form" method="post" action="${pageContext.request.contextPath}/aeas/apply">
						<table id="context_mid_form_table">
							<tr>
								<td>申请人学号</td>
								<td>
									<input id="context_mid_form_table_input" name="assoLeader" type="text" value="${currentUser.userId}" readonly>
								</td>
							</tr>
							<tr>
								<td>申请人</td>
								<td>
									<input id="context_mid_form_table_input" name="userName" type="text" value="${currentUser.userName}" readonly>
								</td>
							</tr>
							<tr>
								<td>社团名称</td>
								<td>
									<input id="context_mid_form_table_input" name="assoName" type="text" value="">
								</td>
							</tr>
							<tr>
								<td>社团简介</td>
								<td>
									<input id="context_mid_form_table_input" name="assoSynopsis" type="text" value="">
								</td>
							</tr>
							<tr>
								<td>社团公告</td>
								<td>
									<input id="context_mid_form_table_input" name="assoNotice" type="text" value="">
								</td>
							</tr>
							<tr>
								<td>申请理由</td>
								<td>
									<input id="context_mid_form_table_input" name="assoReason" type="text" value="">
								</td>
							</tr>
						</table>
						<input id="context_mid_form_btn" type="submit" value="提交申请">
						<font color="red">${successMsg1}</font>
	...
	<script src="<%=path%>/js/myAssociation.js" type="text/javascript"></script>
</body>
<script>
function logout() {
	$.ajax({
